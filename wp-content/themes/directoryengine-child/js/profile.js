                ...
                new Views.BlockControl({
                    ...
                    onAfterFetch : function( result, res){
                        ...
                        if (res.success) {
                            ...
                            $('.list-place-tabs li select option').each(function () {
                                var value = $(this).attr('value'),
                                    type = $(this).data('type');
                                $(this).text(type + ' (' + res.total_status[value] + ')')
                                if (res.type_status == value) {
            ...
            if (this.submit_validator.form() && !form.hasClass("processing")) {
                ...
                this.user.request('update', {
                    beforeSend: function() {
                        ...
                        $('.btn-submit.update_profile').val('Actualizando...');
                    },
                    success: function(result, status, jqXHR) {
                        form.removeClass('processing');
                        $('.btn-submit.update_profile').val('Actualizar Perfil');
                        if (status.success) {
                            //render data
                            ...
                            if (result.get('location') !== "") {
                                location.html(result.get('location'));
                            }else{
                                location.html("<< Añadir localización >>");
                            }

                            if (result.get('phone') !== "") {
                                phone.html(result.get('phone'));
                            }else{
                                phone.html("<< Añadir teléfono >>");
                            }
