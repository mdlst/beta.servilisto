    ...
    class ET_WC_Order extends WC_Abstract_Order
    {
        ...
        public function populate($result)
        {
          ...
          /*  $this->cancel_url = et_get_page_link('process-payment', array('paymentType' => $orderData['payment']));
            ...
            $this->cancel_url =  get_permalink(get_page_by_title('Pasarela'))."?tipo-pago=".$orderData['payment'];
            $this->received_url =  get_permalink(get_page_by_title('Pasarela'))."?tipo-pago=".$orderData['payment'];
            /*********************************************************************************************************/
        }
