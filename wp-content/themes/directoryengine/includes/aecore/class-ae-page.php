...
class AE_Page extends AE_Base
{
    ...
    public function print_scripts() {
        ...
        //$this->add_script('et-googlemap-api', get_stylesheet_directory_uri() . '/js/my_google_maps.js', array());
		$this->add_script('et-googlemap-api', 'https://maps.googleapis.com/maps/api/js?key=AIzaSyCdCbihsv-CElefbB7Gikt6ZomYyVqBdiw', array('jquery'), ET_VERSION, true);
