 ...
 */
		 ...
		 */
		$month_names = array(isset($dot_text['MONTH_JANUARY_JS']) ? $dot_text['MONTH_JANUARY_JS']:'January',
				     isset($dot_text['MONTH_FEBRUARY_JS']) ? $dot_text['MONTH_FEBRUARY_JS']:'February',
				     isset($dot_text['MONTH_MARCH_JS']) ? $dot_text['MONTH_MARCH_JS']:'March',
				     isset($dot_text['MONTH_APRIL_JS']) ? $dot_text['MONTH_APRIL_JS']:'April',
				     isset($dot_text['MONTH_MAY_JS']) ? $dot_text['MONTH_MAY_JS']:'May',
				     isset($dot_text['MONTH_JUNE_JS']) ? $dot_text['MONTH_JUNE_JS']:'June',
				     isset($dot_text['MONTH_JULY_JS']) ? $dot_text['MONTH_JULY_JS']:'July',
				     isset($dot_text['MONTH_AUGUST_JS']) ? $dot_text['MONTH_AUGUST_JS']:'August',
				     isset($dot_text['MONTH_SEPTEMBER_JS']) ? $dot_text['MONTH_SEPTEMBER_JS']:'September',
				     isset($dot_text['MONTH_OCTOBER_JS']) ? $dot_text['MONTH_OCTOBER_JS']:'October',
				     isset($dot_text['MONTH_NOVEMBER_JS']) ? $dot_text['MONTH_NOVEMBER_JS']:'November',
				     isset($dot_text['MONTH_DECEMBER_JS']) ? $dot_text['MONTH_DECEMBER_JS']:'December');
		$month_short_names = array(isset($dot_text['MONTH_SHORT_JANUARY_JS']) ? $dot_text['MONTH_SHORT_JANUARY_JS']:'Jan',
					   isset($dot_text['MONTH_SHORT_FEBRUARY_JS']) ? $dot_text['MONTH_SHORT_FEBRUARY_JS']:'Feb',
					   isset($dot_text['MONTH_SHORT_MARCH_JS']) ? $dot_text['MONTH_SHORT_MARCH_JS']:'Mar',
					   isset($dot_text['MONTH_SHORT_APRIL_JS']) ? $dot_text['MONTH_SHORT_APRIL_JS']:'Apr',
					   isset($dot_text['MONTH_SHORT_MAY_JS']) ? $dot_text['MONTH_SHORT_MAY_JS']:'May',
					   isset($dot_text['MONTH_SHORT_JUNE_JS']) ? $dot_text['MONTH_SHORT_JUNE_JS']:'Jun',
					   isset($dot_text['MONTH_SHORT_JULY_JS']) ? $dot_text['MONTH_SHORT_JULY_JS']:'Jul',
					   isset($dot_text['MONTH_SHORT_AUGUST_JS']) ? $dot_text['MONTH_SHORT_AUGUST_JS']:'Aug',
					   isset($dot_text['MONTH_SHORT_SEPTEMBER_JS']) ? $dot_text['MONTH_SHORT_SEPTEMBER_JS']:'Sep',
					   isset($dot_text['MONTH_SHORT_OCTOBER_JS']) ? $dot_text['MONTH_SHORT_OCTOBER_JS']:'Oct',
					   isset($dot_text['MONTH_SHORT_NOVEMBER_JS']) ? $dot_text['MONTH_SHORT_NOVEMBER_JS']:'Nov',
					   isset($dot_text['MONTH_SHORT_DECEMBER_JS']) ? $dot_text['MONTH_SHORT_DECEMBER_JS']:'Dec');
