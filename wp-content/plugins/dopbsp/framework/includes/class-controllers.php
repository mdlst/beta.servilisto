 ...
 */
    ...
    if (!class_exists('DOTControllers')){
		 ...
		 */
		$files = $DOT->classes->files->scan($DOT->paths->abs.$addon_folder.'/application/controllers/');
		...
		foreach ($files as $file){
		    ...
		    $this->data[$key]->file = $DOT->paths->abs.$addon_folder.'/application/controllers/'.$file;
