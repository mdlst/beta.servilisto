 ...
 * File                    : application/controllers/user/smses.php
 * Author                  : PINPOINT.WORLD
 * Copyright               : © 2018 PINPOINT.WORLD
 * Website                 : https://www.pinpoint.world
 * Description             : User SMSes controller PHP class.
 */

    if (!class_exists('DOTControllerUserSmses')){
        class DOTControllerUserSmses{
            /*
             * Constructor
	     * 
	     * @usage
