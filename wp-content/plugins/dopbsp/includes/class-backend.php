            ...
            function rating(){
                ...
                if ($request_rating === 'true'){
                    ...
                    if(time()-strtotime($install_date) > 5259486){
                        ...
                        array_push($error, '    <a href="https://pinpoint.world/shop/reviews/pinpoint-booking-system-wordpress-plugin-pro-version-1?utm_source=WordPress&utm_medium=Plugin%20PRO" target="_blank"> here</a>. ');
                        array_push($error, '  </p>');
