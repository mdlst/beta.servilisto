        ...
        class DOPBSPBackEndReservationNotifications extends DOPBSPBackEndReservation{
            ...
            function send($reservation_id,
                ...
                $translation = $DOPBSP->classes->backend_email->get((int)$settings_notifications->templates,
                                                                    $template);
                $sms_translation = $DOPBSP->classes->backend_sms->get((int)$settings_notifications->templates,
                                                                    $template);
                ...
                if (strpos($template, 'admin') !== false){
                    ...
                    $email_from = $settings_notifications->admin_email_sender !== '' ? $settings_notifications->admin_email_sender : $reservation->email;
                    $email_reply = '';
                    $email_name = '';
                    $email_cc = '';
                    $email_cc_name = '';
