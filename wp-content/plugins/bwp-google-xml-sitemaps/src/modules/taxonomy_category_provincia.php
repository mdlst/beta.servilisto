 ...
 */
class BWP_GXS_MODULE_TAXONOMY_CATEGORY_PROVINCIA extends BWP_GXS_MODULE
{
    ...
    protected function generate_data()
    {
        ...
        $provincias = $this->get_results($wpdb->prepare($term_query, "location"));
        ...
        for ($i = 0; $i < sizeof($terms); $i++) {
            foreach ($provincias as $provincia) {
                ...
                $data['location'] = $this->get_term_link($term, $requested) . "/en-" . $provincia->slug."/";
